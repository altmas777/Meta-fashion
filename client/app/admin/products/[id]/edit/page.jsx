...
export default function EditProductPage({ params }) {
  ...
  if (isLoading) return <div className="animate-pulse">Loading product details...</div>;

  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-serif text-primary mb-8">Edit Product</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex gap-4 justify-end">
          ...
          <button type="submit" disabled={isSubmitting} className="btn-primary">{isSubmitting ? 'Saving...' : 'Update Product'}</button>
        </div>
      </form>
    </div>
  );
